...
<head>
	...
	<title><spring:message code="classesTitle"/> </title>
...
<body>
	...
	<div class="container">
		...
		<form:form modelAttribute="class">
				<form:errors path="className" cssClass="errorblock" element="div"/>
				...
				<input type="submit" class="btn" value="<spring:message code="searchButton"/>" id="searchButton"/>
